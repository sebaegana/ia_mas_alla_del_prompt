...
<ul style="list-style-type:none; padding-left:0;">
<li>Buen desempeño en demos  </li>
<li> ❌ Frágiles en producción  </li>
<li> ❌ Difíciles de auditar  </li>
<li>❌ Resultados no reproducibles  </li>
</ul>
...
<ul style="list-style-type:none; padding-left:0;">
<li>🟢 Memoria de corto plazo (ventana de contexto): se mantiene dentro de la conversación  y está limitada por tokens </li>
...
<ul style="list-style-type:none; padding-left:0;">
<li> Revisa la plataforma de OpenAI para explicar el concepto de tokens: <https://platform.openai.com/tokenizer> </li>
<li> Proyecto orientado a hacer competir las IA en trading: <https://nof1.ai> </li>
